...
class Model {
  ...
  public:
    ...
    real binaryLogistic(int32_t, bool, real, bool bup=true);
    real negativeSampling(int32_t, real, bool bup=true);
    real hierarchicalSoftmax(int32_t, real, bool bup=true);
    real softmax(int32_t, real);

    void predictPVDM(const std::vector<int32_t>&, int32_t,
                     std::shared_ptr<Matrix>, real);
    ...
    void computeHidden(const std::vector<int32_t>&, std::shared_ptr<Matrix>, Vector&) const;

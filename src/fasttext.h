...
class FastText {
 ...
 public:
  ...
  void rskipgram(Model&, real, const std::vector<int32_t>&);
  ...
  void predictPVDM(std::istream&, const std::string&, int32_t);
  void predictPVDM(const std::vector<std::string>&,
